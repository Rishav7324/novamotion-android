...
/**
 * Manages EGL 1.4 context and window surface bound to a MediaCodec input surface
 * for hardware-accelerated offline MP4 video encoding.
 */
class EglSurfaceRenderer(private val surface: Surface) {
    ...
    private fun initEGL() {
        ...
        val contextAttribs = intArrayOf(
            EGL14.EGL_CONTEXT_CLIENT_VERSION, 3, // GLES 3.0
            EGL14.EGL_NONE
        )
